<template>
  <div class="forum">
    ...
    >
      <el-form label-position="top" ref="forbidForm" :model="forbidForm" label-width="80px">
        ...
        <el-form-item label="禁言原因" size="mini">
          <el-form-item>
            <el-input  :rows="3" type="textarea" maxlength="40" v-model="forbidForm.reason"></el-input>
          </el-form-item>
        </el-form-item>
        <el-form-item>
    ...
    <div class="footer" v-if="!type">
      <reply-lzl :reviewOwner="creator" @toDetail="toReplyDetailMore" @reloadPageLzl="reloadPage" @openForbid="openForbid" :forbid="forbid" :mouduleOwn="mouduleOwn" :moduleId="moduleId" :reviewId="reviewId" :like="like"  :likeCount="likeCount" :replies="replies" @comment="comment(reviewId)" @commentLzl="commentLzl"></reply-lzl>
    </div>
  </div>
</template>
