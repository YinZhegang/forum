<template>
    <div style="padding-top: 2.5rem" class="allmodule">
      <van-tabs v-model="active" title-active-color="#26a2ff" sticky title-inactive-color="#000000" color="#26a2ff" animated swipeable>
