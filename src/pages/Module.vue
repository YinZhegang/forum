<template>
  <div class="model" id="top">
    ...
    <div v-if="!forbid" @click="toPost" style="box-shadow:rgba(117,117,117,0.67) 4px 3px 2px;position: fixed;bottom: 50px;right: 30px;z-index: 99;font-size: 1.6rem;color: #ffffff;background: #26a2ff;border-radius: 100px;width: 60px;height: 60px;text-align: center;line-height: 60px"><i class="el-icon-edit"></i></div>
    <div v-else style="position: fixed;bottom: 50px;right: 30px;z-index: 9999;font-size: 1.6rem; color: #ffffff;background: #757575;border-radius: 100px;width: 60px;height: 60px;text-align: center;line-height: 60px"><i class="el-icon-edit"></i></div>
    ...
    <div class="content">
      <van-tabs v-model="active" title-active-color="#26a2ff" title-inactive-color="#000000" sticky color="#26a2ff" swipeable>
        <van-tab title="全部">
...
<style scoped lang="scss">
  /deep/ .van-sticky--fixed{top: 40px;right: 0;width: 100%;background-color: #fff}
